<?php  
$page_title = "Employer | Applicants Page";
...
<main style="padding-top:55px; min-height: calc(110vh - 70px);">
        ...
        <br>
        <div class="jobs">
        <h2>Applicants <small> List of applicants that has a pending status </small></h2>
            ...
            <table width:100%>
                ...
                <?php
                    ...
                    WHERE apply.status='pending' AND jobs.empid = $empid ORDER BY appid DESC";  
                ...
                <?php
                    ...
                    echo "
                    <tr>
                    <td colspan='7'> <div style='justify-content:center; align-items:center; background-color: #ececec'> <span style='color: gray; font-size:large'; font-weight:700;> There are no pending applicants yet </span></div> </td>
                    </tr>";
                } ?>    
                </tbody>
            </table>
